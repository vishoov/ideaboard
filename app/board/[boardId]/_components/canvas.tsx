...
import { Camera, CanvasMode, CanvasState, Color, LayerType, Side, XYWH, point } from "@/types/canvas";
...
export const Canvas = ({
    ...
    const insertLayer=useMutation((
        ...
        layerType: LayerType.Ellipse | LayerType.Rectangle | LayerType.Text | LayerType.Text | LayerType.Note,
        position:point,
    )=>{
